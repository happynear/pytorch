...
void THDTensor_(kthvalue)(THDTensor *self, THDLongTensor *indices_, THDTensor *src, int64_t k, int dimension) {
...
void THDTensor_(nonzero)(THDLongTensor *subscript, THDTensor *tensor) {
  ...
  int64_t int64_t numel = receiveValueFromWorker<int64_t>(tensor->storage->node_id);
